...
load("user_input/breast_cancer_meth450.Rdata") #USER INPUT FILE 1
...
load("precomputed_data_breastcancermodel.Rdata") #provided
...
write.csv(finalModel, file = "finalModel.csv", quote = F, row.names = F)

print("Model calculation done!  Saved to current directory as finalModel.csv")
